    ...
    useEffect(() => {
        const fetchGaming = async () => {
            try {
                ...
                const gamingProducts = response.data.filter(product => product.category === 'Gaming');
                const productsWithValidImages = gamingProducts.map(product => {
        ...
        <Box sx={{ 
            ...
            <Container maxWidth="xl">
                ...
                <Breadcrumbs sx={{ py: 2 }}>
                    ...
                    <Typography color="textPrimary" sx={{ color: 'white' }}>Gaming</Typography>
                </Breadcrumbs>
