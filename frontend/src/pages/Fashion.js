    ...
    useEffect(() => {
        const fetchFashion = async () => {
            try {
                ...
                const fashionProducts = response.data.filter(product => product.category === 'Fashion');
                const productsWithValidImages = fashionProducts.map(product => {
        ...
        <Box sx={{ 
            ...
            <Container maxWidth="xl">
                ...
                <Breadcrumbs sx={{ py: 2 }}>
                    ...
                    <Typography color="textPrimary" sx={{ color: 'white' }}>Fashion</Typography>
                </Breadcrumbs>
